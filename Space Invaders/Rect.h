...
public:
	...
	inline void Draw(class D3DGraphics& gfx)
	{
		gfx.DrawLine((int)left, (int)top, (int)right, (int)top, RED);
		gfx.DrawLine((int)right, (int)top, (int)right, (int)bottom, RED);
		gfx.DrawLine((int)right, (int)bottom, (int)left, (int)bottom, RED);
		gfx.DrawLine((int)left, (int)bottom, (int)left, (int)top, RED);
	}
public:
	T top;
	T bottom;
